...
<html>
	...
	<body>
		<a href="#edit-medicalTest" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-medicalTest" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${medicalTestInstance?.version}" />
				<fieldset class="form">
