...
<html>
	...
	<body>
		<a href="#list-bloodPressure" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-bloodPressure" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${bloodPressureInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
