...
<html>
	...
	<body>
		<a href="#edit-bloodPressure" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-bloodPressure" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${bloodPressureInstance?.version}" />
				<fieldset class="form">
